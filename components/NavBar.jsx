...
import { FaUser, FaSignInAlt, FaBlog, FaInfoCircle, FaLaptopCode, FaMicrochip, FaMobileAlt, FaPlusSquare } from 'react-icons/fa';
      ...
      <Container>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="me-auto">
            ...
            <NavDropdown title={<span className="text-dark"><FaLaptopCode className="me-1" /> Hot topics</span>} id="basic-nav-dropdown">
              ...
              <NavDropdown.Item href="/categories/gadgets" className="text-dark">
